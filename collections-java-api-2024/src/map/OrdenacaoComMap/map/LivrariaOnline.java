...
public class LivrariaOnline {
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorPreco(){
        ...
        Collections.sort(livrosParaOrdenarPorPreco, new ComparandoPorPreco());
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorAutor(){
        ...
        Collections.sort(livrosParaOrdenarPorAutor, new ComparandoPorAutor());
    ...
    public List<Livro> obterLivroMaisCaro(){
        ...
        for (Map.Entry<String, Livro> entry : livros.entrySet()){
            if (entry.getValue().getPreco() == precoMaisAlto){
                ...
                livroMaisCaro.add(livroComPrecoMaisBaixo);
            }
        }
    ...
    public List<Livro> exibirLivroMaisBarato(){
        ...
        for (Map.Entry<String, Livro> entry : livros.entrySet()){
            if (entry.getValue().getPreco() == precoMaisBaixo){
                Livro livroComPrecoMaisBaixo = livros.get(entry.getKey());
                livroMaisBaratos.add(livroComPrecoMaisBaixo);
            }
        }
